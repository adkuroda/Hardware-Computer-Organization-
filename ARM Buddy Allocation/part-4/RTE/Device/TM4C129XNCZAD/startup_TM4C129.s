...
;  ***************** Stard My Code **************
				IMPORT _systemcall_table_jump  ; improt the _systemcall_table_jump
                PUSH  {lr} ;store the link register to stack 
				LDR r11, =_systemcall_table_jump  ;load the _systemcall_table_jump to reg 11 
				BLX r11 ; branch with link to _systemcall_table_jump (line 224 for my reference) 
...
; *****************  START CODE *****************************
				POP {pc}  ;pop the stack and copy the link register to program counter 
